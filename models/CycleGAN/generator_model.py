...
class Generator(nn.Module):
	def __init__(self, in_channels=12, num_features = 64, num_residuals=9):
		super().__init__()
		self.initial = nn.Sequential(
			nn.Conv1d(in_channels, num_features, kernel_size=7, stride=1, padding=3, padding_mode='reflect'),
